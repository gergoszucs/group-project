...
In general, we feel that we learned a lot of thing during the last 9 weeks. The best part of the project was \textbf{working with people from different countries and cultures}, while also bringing \textbf{different vision} due to the previous studies we have had. It was interesting to see, what ideas each team member had for the development and what we were interested in working on.
