...
In order to support the program on any device it could be hosted in the cloud. 
We investigated the possibility of running the program on AWS (Amazon Web Services). 
