...
const QMetaObject QJsonModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_QJsonModel.data,
      qt_meta_data_QJsonModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QJsonModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QJsonModel.stringdata0))
        return static_cast<void*>(const_cast< QJsonModel*>(this));
