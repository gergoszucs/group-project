...
// Edit mode flags.
EDIT_MODES_ENUM MY_EDIT_MODE; // NONE, etc. Note that the enum type itself is defined in global.h.
...
int main(int argc, char *argv[])
{
	...
	project->printDebug(__FILE__, __LINE__, __FUNCTION__, 2, "Inside main.");
